            ...
            case R.id.negativeButton:
                if (operators.size() == 0) {
                    ...
                    if (output.getText().length() == location) {
                        ...
                        String lastNum = output.getText().toString().substring(location);
                        if (lastNum.equals("-")) {
                            output.setText(output.getText().toString().substring(0, output.length() - 1));
                        } else if (Character.isDigit(lastNum.charAt(0))) {
                            output.setText(output.getText().toString().substring(0, location) + "-" + lastNum);
                        } else if (lastNum.substring(0, 1).equals("-")) {
